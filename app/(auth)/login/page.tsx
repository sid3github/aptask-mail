    ...
    <div className="grid min-h-svh place-items-center bg-bg px-4">
      <div className="w-full max-w-md">
        ...
        <div className="mt-6 grid gap-3">
          {hasGoogle && (
            <form action="/api/auth/signin/google" method="post">
              <Button type="submit" size="lg" variant="secondary" className="w-full justify-start">
        ...
        {noProvider && (
          <div className="mt-6 rounded-lg border border-amber-500/30 bg-amber-500/10 p-4 text-sm">
            ...
            <p className="mt-1 text-amber-200/80">
              ...
              <code>AZURE_AD_CLIENT_ID</code> / <code>IMAP_ENCRYPTION_KEY</code>{" "}
              in your environment to enable sign-in. See <code>.env.example</code>.
            </p>
            <Link
              href="/inbox"
        ...
        <p className="mt-8 text-center text-xs text-fg-muted">
          By signing in you authorize InboxIQ to read, send, and modify your
          email via OAuth scopes. You can revoke access any time from your
...
function GoogleLogo() {
  return (
    <svg width="16" height="16" viewBox="0 0 48 48" aria-hidden>
      <path
        fill="#FFC107"
        d="M43.6 20.5H42V20H24v8h11.3C33.7 32.4 29.3 35.5 24 35.5 17.6 35.5 12.5 30.4 12.5 24S17.6 12.5 24 12.5c3 0 5.7 1.1 7.7 2.9l5.7-5.7C33.9 6.5 29.2 4.5 24 4.5 13.2 4.5 4.5 13.2 4.5 24S13.2 43.5 24 43.5c10.9 0 19.5-7.9 19.5-19 0-1.3-.1-2.6-.4-4z"
      />
      <path
        fill="#FF3D00"
        d="M6.3 14.1l6.6 4.8C14.7 15.7 19 12.5 24 12.5c3 0 5.7 1.1 7.7 2.9l5.7-5.7C33.9 6.5 29.2 4.5 24 4.5 16.3 4.5 9.7 8.8 6.3 14.1z"
      />
      <path
        fill="#4CAF50"
        d="M24 43.5c5.2 0 9.9-2 13.4-5.2l-6.2-5.2C29.1 34.7 26.7 35.5 24 35.5c-5.3 0-9.7-3.1-11.3-7.5l-6.5 5C9.5 38.9 16.2 43.5 24 43.5z"
      />
      <path
        fill="#1976D2"
        d="M43.6 20.5H42V20H24v8h11.3c-.8 2.4-2.4 4.5-4.5 5.8l6.2 5.2c-.4.4 6.9-5 6.9-15 0-1.3-.1-2.6-.3-4z"
      />
    </svg>
  );
}
